...
public class BookGui extends GuiScreen {
    ...
    public BookGui()
    {
        bookPageTextures[0] = new ResourceLocation(
              MyMod.MODID+":textures/gui/book_cover.png");
        bookPageTextures[1] = new ResourceLocation(
              MyMod.MODID+":textures/gui/book.png");
        bookPageTextures[2] = new ResourceLocation(
              MyMod.MODID+":textures/gui/book.png");
        stringPageText[0] = "";
        stringPageText[1] = "Welcome to your first assignment!.\n\n Turn the page to read more about it.";
        stringPageText[2]="You need to look up the red pillar to start your assignment.\n\n .\n\n";
